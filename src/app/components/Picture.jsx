...
function Picture() {
  return (
    <div className='w-1/2 flex-1 bg-blue-500 rounded-2xl relative'>
      <div className='absolute -top-3 -right-4 md:-top-8 md:right-3 mid:-top-16 lg:-top-20 large:right-16 large:-top-16 extralarge:right-32 extralarge:-top-12 tabletrot:right-20 tabletrot:-top-20 flex items-start gap-2 z-30'>
        ...
        />
        <p className='font-bold text-3xl rotate-[30deg] mt-4 bg-gradient-to-r from-fuchsia-500 to-rose-500 px-2 whitespace-nowrap xl:text-4xl large:text-5xl extralarge:text-6xl'>
          that&apos;s me!
        </p>
      </div>
